...
@org.adempiere.base.Model(table="JP_ToDo_Reminder_Log")
...
// N
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Reminder_Log (Properties ctx, int JP_ToDo_Reminder_Log_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ToDo_Reminder_Log_ID, trxName, virtualColumns);
      /** if (JP_ToDo_Reminder_Log_ID == 0)
        {
			setIsError (false);
// N
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Reminder_Log (Properties ctx, String JP_ToDo_Reminder_Log_UU, String trxName)
    {
      super (ctx, JP_ToDo_Reminder_Log_UU, trxName);
      /** if (JP_ToDo_Reminder_Log_UU == null)
        {
			setIsError (false);
// N
			setJP_ToDo_Reminder_Log_ID (0);
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Reminder_Log (Properties ctx, String JP_ToDo_Reminder_Log_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ToDo_Reminder_Log_UU, trxName, virtualColumns);
      /** if (JP_ToDo_Reminder_Log_UU == null)
        {
			setIsError (false);
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_ToDo_Reminder_Log[")
	...
	*/
	...
	{
		return (I_JP_ToDo_Reminder)MTable.get(getCtx(), I_JP_ToDo_Reminder.Table_ID)
