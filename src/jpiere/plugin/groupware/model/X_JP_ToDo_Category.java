...
@org.adempiere.base.Model(table="JP_ToDo_Category")
public class X_JP_ToDo_Category extends PO implements I_JP_ToDo_Category, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Category (Properties ctx, int JP_ToDo_Category_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ToDo_Category_ID, trxName, virtualColumns);
      /** if (JP_ToDo_Category_ID == 0)
        {
			setJP_ToDo_Category_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Category (Properties ctx, String JP_ToDo_Category_UU, String trxName)
    {
      super (ctx, JP_ToDo_Category_UU, trxName);
      /** if (JP_ToDo_Category_UU == null)
        {
			setJP_ToDo_Category_ID (0);
			setName (null);
        } */
    ...
    /** Standard Constructor */
    public X_JP_ToDo_Category (Properties ctx, String JP_ToDo_Category_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_ToDo_Category_UU, trxName, virtualColumns);
      /** if (JP_ToDo_Category_UU == null)
        {
			setJP_ToDo_Category_ID (0);
			setName (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_ToDo_Category[")
